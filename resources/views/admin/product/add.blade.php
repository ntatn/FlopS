...
<form action="" method="post">
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="price_old" value="{{ old('price_old') }}" class="form-control">
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="content" class="form-control" rows="3" placeholder="" style="height: 86px;">{{ old('description') }}</textarea>
        </div>
        <div class="form-group">
